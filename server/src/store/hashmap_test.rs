...
mod tests {
    ...
    use crate::store::{HashMapDataStore, ConfigPath};
    use crate::store::DataStoreError;
    use crate::store::DataStoreError:: {NotFound, InvalidPath};
    ...
    async fn test_list() {
        ...
        let list = store.list(&ConfigPath::new("/my/path").unwrap()).await.unwrap();
